...
class CGRU_cell(nn.Module):
    ...
    ConvGRU Cell
    """
    def __init__(self, shape, input_channels, filter_size, num_features, dilation=1):
...
class CLSTM_cell(nn.Module):
    ...
    def __init__(self, shape, input_channels, filter_size, num_features,dilation=1):
        ...
        self.padding = dilation*(filter_size - 1) // 2
    ...
    def forward(self, inputs=None, hidden_state=None, seq_len=10):
        ...
        for index in range(seq_len):
            ...
            # print(gates.shape)                                                      # it should return 4 tensors: i,f,g,o
